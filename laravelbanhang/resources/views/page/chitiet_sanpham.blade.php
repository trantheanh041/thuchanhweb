			...
			<div class="row">
				<div class="col-sm-9">
					<div class="row">
						...
						<div class="col-sm-8">
							<div class="single-item-body">
								<p class="single-item-title"><h2>{{$sanpham->name}}</h2><br></p>
					...
					<div class="beta-products-list">
							...
							<div class="col-sm-4">
								<div class="single-item">
									...
									<div class="single-item-header">
										<a href="chi-tiet-san-pham/{{$sptt->id}}"><img src="source/image/product/{{$sptt->image}}" alt="" height="250px"></a>
									</div>
									<div class="single-item-body">
									...
									<div class="single-item-caption">
										<a class="add-to-cart pull-left" href="add-to-cart/{{$sptt->id}}"><i class="fa fa-shopping-cart"></i></a>
						...
						<br><div class="row" style= " font-size: 20px">{{$sp_tuongtu->links()}}</div>

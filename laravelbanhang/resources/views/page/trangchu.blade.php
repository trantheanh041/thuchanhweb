				...
				<div class="row">
					<div class="col-sm-12">
						<div class="beta-products-list">
							...
							<div class="row" style= " font-size: 20px"><br>{{$new_product->links()}} </div>
						...
						<div class="beta-products-list">
							...
							<div class="row">
								...
								<div class="col-sm-3">
									<div class="single-item">
										<div class="single-item-header"><br>
											<a href="chi-tiet-san-pham/{{$spkm->id}}"><img src="source/image/product/{{$spkm->image}}" alt="" height="250px"><br></a>
										</div>
										<div class="single-item-body">
										...
										<div class="single-item-caption">
											...
											<a class="beta-btn primary" href="chi-tiet-san-pham/{{$spkm->id}}">Chi tiết <i class="fa fa-chevron-right"></i></a>
											<div class="clearfix"></div>
										</div>
									</div>
								</div>
							...
							<div class="row" style= " font-size: 20px"><br>{!!$sanpham_khuyenmai->links()!!} </div>
						</div> <!-- .beta-products-list -->
					</div>
